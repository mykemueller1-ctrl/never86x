...
export const metadata = {
  title: "Start with your papers",
  description: "Check invoices with no login, or open the fictional sample.",
};
  ...
  return (
    <div className="mx-auto max-w-lg px-4 py-8">
      ...
      <p className="mt-2 text-[var(--muted)]">
        Your invoices stay on this phone. The sample is a fictional restaurant.
      </p>
      <PlaceNameForm />
